from sisl_games.pursuitTweak.pursuitTweak import env as custom_env
import ray
...
env_name = "pursuitTweak"
# path should end with checkpoint-<> data file
checkpoint_path = "./ray_results/pursuitTweak/PPO/1/checkpoint_1000/checkpoint-1000"
Trainer = PPOTrainer
